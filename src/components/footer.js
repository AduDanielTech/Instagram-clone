...
import { UserDetails,StoryData,GlobalData } from './useContext';
import { nanoid } from 'nanoid';

function Footer({Link,postImg,setpostimg,desktopView }) {
  const {story} = useContext(UserDetails)
  const{ askforusername,setAskForUsername,linkNoWork} = useContext(GlobalData)
 ...
 function onClickFooterButton(name) {
 
    setFooter(pre => {
      return {
        ...pre,
        homelogo: name === "homelogo" ? true : false,
        Explore: name === "Explore" ? true : false,
        Post: name === "Post" ? true : false,
        ForWard: name === "ForWard" ? true : false,
        profile: name === "profile" ? true : false,
        notifications: name === "notifications" ? true : false,
        search: name === "search" ? true : false,
        more: name === "more" ? true : false,
        showOthers: name === "more" ? true : false,
    ...
    function deleteAllSearch() {
      let parentEl=   document.querySelectorAll('.recent')
      let returned = parentEl === null ? '' : parentEl.forEach(allsuggested =>{
        allsuggested.remove()
      })
      return returned
      }
      ...
      function toggleBold(e) {
        // Get the currently bolded div (if there is one)
        var boldedDiv = document.querySelector('.bolded');
        
        // If there is a currently bolded div, remove the bold class from it
       
         if (boldedDiv ) {
          boldedDiv.classList.remove('bolded');
         }
        
        // Add the bold class to the div that was clicked
  ...
  function onClickHome(e) {
    ...
    onClickFooterButton("homelogo");
  }
  
  function onClickExplore(e) {
    toggleBold(e)
    
    onClickFooterButton("Explore");
  }
  function onClickMore(e) {
    toggleBold(e)
    onClickFooterButton("more");
  }
  ...
  function onClickForward(e) {
    ...
    onClickFooterButton("ForWard");
  }
  
  function onClickUserPage(e) {
    toggleBold(e)
    
    onClickFooterButton("profile");
  }
  function onClickSearch(e) {
    toggleBold(e)
    
    onClickFooterButton("search");
  }
  function onClicknotifications(e) {
    toggleBold(e)
    
   
    onClickFooterButton("notifications");
  }
  function logOut() {
 ...
 footer.instagramLogo ? 
    <svg aria-label="Instagram" className="_ab6- instagram-logo-login" color="#262626" fill="#262626" height="29" role="img" viewBox="32 4 113 32" width="103">
 ...
 <Link to='/homepage' >
          <span className="footer-span home-logo bolded logo" onClick={onClickHome}>
            ...
            {footer.instagramLogo ?  <div>Home</div> : <></>} 
          </span>
      </Link>
          ...
          <span className="footer-span home-logo logo" onClick={onClickSearch}>
            ...
            {footer.instagramLogo ?  <div>Search</div> : <></>} 
          </span>
       ...
       <Link to='*' className='back-to-homepage'  onClick={onClickForward}>
              ...
              {footer.instagramLogo ?  <div> Messages</div> : <></>} 
          ...
          <span className="footer-span post-logo logo" onClick={onClickPost}>
            { footer.Post
              ...
              <svg aria-label="New post" className="_ab6-" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24"><path d="M2 12v3.45c0 2.849.698 4.005 1.606 4.944.94.909 2.098 1.608 4.946 1.608h6.896c2.848 0 4.006-.7 4.946-1.608C21.302 19.455 22 18.3 22 15.45V8.552c0-2.849-.698-4.006-1.606-4.945C19.454 2.7 18.296 2 15.448 2H8.552c-2.848 0-4.006.699-4.946 1.607C2.698 4.547 2 5.703 2 8.552Z" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path><line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="6.545" x2="17.455" y1="12.001" y2="12.001"></line><line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="12.003" x2="12.003" y1="6.545" y2="17.455"></line></svg>
                 ...
                 {footer.instagramLogo ?  <div> Create</div> : <></>} 
     ...
     <div className='others-cont-'>
        ...
        <div className="others-cont-divs" onClick={linkNoWork}>
          <div>Saved</div> <svg aria-label="Saved" class="_ab6-" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24"><polygon fill="none" points="20 21 12 13.44 4 21 4 3 20 3 20 21" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></polygon></svg></div>
        <div className="others-cont-divs" onClick={linkNoWork}><div>Switch apperance</div>
   ...
   <div className="shareDivs share-to " key={nanoid()}>
   <input type="text" placeholder='Search...' />
   </div>
   <div className="shareDivs share-suggestions">
    <div className="search-header">
   <div> Suggestions</div>    <div onClick={deleteAllSearch}> Clear All</div>
    </div>
     <div className='friends'  key={nanoid()} >
     {story.map((user) =>{
 const {
  name:{first},
  location:{postcode,
...
function deleteSearch(t) {
  let parentEl=   t.target.parentElement.parentElement  
  parentEl.remove()
}  
  ...
  return (
      <StoryData.Provider value={{
         ...
         <div className="friend  recent"  key={nanoid()}>
